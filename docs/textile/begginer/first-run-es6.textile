h1(#first-run-on-es6--begginer--openlayer-guid). First run on ES6 / Begginer / Openlayer Guid
...
Put a map on a page Below you'll find a complete working example. You can create a new file, copy in the contents below, and open in a browser.

"Open example in new tab":../../../examples/begginers/first-run-es6/

h4(#indexhtml). index.html
